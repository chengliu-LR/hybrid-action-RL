...
plt.figure(dpi=500)
plt.plot(data_mpdqn[:,-1], color='coral', label='MP-DQN')
plt.plot(data_pdqn[:,-1], color='dodgerblue', label='P-DQN')
plt.plot(data_paddpg[:,-1], color='slategray', label='PADDPG')
plt.plot(data_qpamdp[:,-1], color='lightseagreen', label='QPAMDP')
...
plt.figure(dpi=500)
plt.plot(data_mpdqn[:,-2], color='coral', label='MP-DQN')
plt.plot(data_pdqn[:,-2], color='dodgerblue', label='P-DQN')
plt.plot(data_paddpg[:,-2], color='slategray', label='PADDPG')
plt.plot(data_qpamdp[:,-2], color='lightseagreen', label='QPAMDP')
plt.xlabel('Episodes (x10^2)')
plt.ylabel('Rewards')
